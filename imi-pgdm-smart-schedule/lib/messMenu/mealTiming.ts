 ...
 */
export const MEAL_TIMINGS: Record<MealType, { start: number; end: number; label: string }> = {
...
export function getMealServingStatus(now: Date = new Date()): MealServingStatus {
