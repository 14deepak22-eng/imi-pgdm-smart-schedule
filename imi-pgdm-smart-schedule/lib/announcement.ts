...
export const ANNOUNCEMENT = {
  ...
  title: 'Update',
  message: 'Major bugs have been fixed! Please hard refresh the website. Seniors: Go to Settings and reselect your subjects. Juniors: Just select your respective section. 🚀',
